                ...
                <form action="">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" id="description"
                                  style="height: 20vh;">deskripsi lama</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="form-text">Aktif akan membuat produk bisa dilihat oleh semua orang, non-Aktif produk
                            tidak bisa dilihat oleh orang</p>
                        <input type="radio" class="btn-check" name="is_active" value="1" id="option1" autocomplete="off"
                               checked>
                        <label class="btn btn-outline-success" for="option1">Aktif</label>

                        <input type="radio" class="btn-check" name="is_active" value="0" id="option2"
                               autocomplete="off">
