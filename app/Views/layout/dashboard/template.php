...
<body class="sb-nav-fixed">
    ...
    <!-- untuk pisah bagian kiri dan kanan -->
    ...
    <script src="<?= base_url('assets/sb-admin/assets/demo/chart-area-demo.js') ?>"></script>
    <script src="<?= base_url('assets/sb-admin/assets/demo/chart-bar-demo.js') ?>"></script>
    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js" crossorigin="anonymous"></script>
    <script src="<?= base_url('assets/sb-admin/js/datatables-simple-demo.js') ?>"></script>
</body>
